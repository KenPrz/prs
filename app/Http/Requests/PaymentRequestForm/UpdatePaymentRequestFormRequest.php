...
class UpdatePaymentRequestFormRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        $paymentRequestForm = $this->route('payment_request_form');

        return $this->user()->can('update', $paymentRequestForm);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            ...$this->removedAttachmentRules(PaymentRequestForm::class, 'payment_request_form'),
        ];
    }
